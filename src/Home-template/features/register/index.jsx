...
function Register() {
  ...
  return (
    ...
    >
      {(formikProps) => {
        const { touched, errors, isValid, handleChange } = formikProps;
        return (
          <div className="register">
            ...
            <Form className="register__form">
              ...
              {errors.taiKhoan && touched.taiKhoan ? (
                <p className="message">{errors.taiKhoan}</p>
              ) : (
                ""
              )}
              <div className="register__formGroup">
              ...
              {errors.matKhau && touched.matKhau ? (
                <p className="message">{errors.matKhau}</p>
              ) : (
                ""
              )}
              <div className="register__formGroup">
              ...
              {errors.email && touched.email ? (
                <p className="message">{errors.email}</p>
              ) : (
                ""
              )}
              <div className="register__formGroup">
              ...
              {errors.hoTen && touched.hoTen ? (
                <p className="message">{errors.hoTen}</p>
              ) : (
                ""
              )}
              <div className="register__formGroup">
              ...
              {errors.soDt && touched.soDt ? (
                <p className="message">{errors.soDt}</p>
              ) : (
                ""
              )}
              <div className="register__formGroup">
              ...
              <p className="register__form--text">
                Đăng ký ngay để được nhiều ưu đãi, mua vé và bảo mật thông tin!{" "}
              </p>
              <div className="register__form--button">
                ...
                <p className="register__form--text">
                  ...
                  <Link to="/home/log-in"> đăng nhập tại đây</Link>
                </p>
              </div>
            </Form>
          </div>
